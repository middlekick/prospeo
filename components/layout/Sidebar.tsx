...
export default function Sidebar() {
  ...
  return (
    ...
    <button
      ...
      className="md:hidden fixed top-3 left-3 z-[55] w-9 h-9 rounded-xl bg-[#15171f] border border-white/[0.1] flex items-center justify-center text-slate-300 shadow-lg"
    >
    ...
    {mobileOpen && (
      <div
        ...
        className="md:hidden fixed inset-0 z-[58] bg-black/60 backdrop-blur-sm"
      />
    )}

    <aside className={[
      "fixed left-0 top-0 h-screen w-[220px] flex flex-col bg-[#0d0f18] border-r border-white/[0.06]",
      ...
      <div className="flex items-center gap-3 px-4 py-5 shrink-0">
        ...
        <button
          ...
          className="md:hidden ml-auto w-7 h-7 rounded-lg bg-white/[0.05] flex items-center justify-center text-slate-500 hover:text-slate-200"
        >
          ✕
        </button>
      </div>
